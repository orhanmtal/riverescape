// River Escape - Dil Paketleri (TR/EN) - v1.99.3.20 (ELITE RE-BRAND RELEASE)
const translations = {
    tr: {
    ...
    en: {
        ...
        reviveBtn: "+1 LIFE (Ad) 📺",
        reviveGoldBtn: "+3 LIVES (500 Gold) 💰",
